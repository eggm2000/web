...
class Carrera(models.Model):
    ...
    duracion = models.PositiveSmallIntegerField(default=5)  # Corregido: PositiveSmallIntergerField a PositiveSmallIntegerField
...
class Estudiante(models.Model):  # Mover la clase fuera de la clase Carrera
    dni = models.CharField(max_length=8, primary_key=True)
    apellidoPaterno = models.CharField(max_length=35)
    apellidoMaterno = models.CharField(max_length=35)
    nombres = models.CharField(max_length=35)
    fechaNacimiento = models.DateField()  # Corregido: Se recomienda usar DateField para fechas
    sexos = [
        ('F', 'Femenino'),
        ('M', 'Masculino')
    ]
    ...
    vigencia = models.BooleanField(default=True)  # Corregido: defaul a default
